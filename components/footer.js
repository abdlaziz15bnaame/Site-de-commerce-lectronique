...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font p-12 ">
  <div className="container px-5 py-24 mx-auto bg-gray-200">
    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4 items-center justify-around ">
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 courser-pointer hover:text-gray-800">Home</a>
          </li>
          <li>
